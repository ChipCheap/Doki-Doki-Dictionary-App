...
5. **Implement with Unity idioms.** Follow Unity best practices (caching, serialization conventions, lifecycle hooks, reflection-driven members) per `references/unity-implementation.md`.
