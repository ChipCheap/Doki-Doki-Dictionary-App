...
The full mechanism for the `## Skill Behaviors` section in `CLAUDE.md` is documented in the **generic-specifier** skill's `references/claude-md-behavior-section.md`. Read that for the structure, creation flow, rule application, and update procedure.
